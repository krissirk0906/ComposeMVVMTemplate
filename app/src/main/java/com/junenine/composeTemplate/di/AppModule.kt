...
import com.junenine.composeTemplate.data.repository.MathRepositoryImplement
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideMathRepository(api: ApiInterface): MathRepository {
        return MathRepositoryImplement(api)
    }
}